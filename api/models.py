...
class Teacher(models.Model):
    ...
    image = models.FileField(upload_to='course-file', default='teacher.png', null=True, blank=True)
...
class Category(models.Model):
    ...
    image = models.FileField(upload_to='course-file', default='category.png', null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        print("Saving Category:", self.title)
        print("Saving sllug:", self.slug)
...
class Course(models.Model):
    ...
    file = models.FileField(upload_to='course-file', default='course.png', null=True, blank=True)
    image = models.FileField(upload_to='course-file', default='course.png', null=True, blank=True)
    title = models.CharField(max_length=200)
    description = models.TextField(null=True, blank=True)
    price = models.DecimalField(max_digits=12, decimal_places=2, default=0.00)
    language = models.CharField(choices=LANGUAGES, max_length=100, null=True, blank=True, default='English')
    level = models.CharField(choices=LEVEL, max_length=100, null=True, blank=True, default='Beginner')
    ...
    def save(self, *args, **kwargs):
        if not self.slug or self.slug == '':
            self.slug = slugify(self.title)  # Learning Python = learning-python
...
class Variant(models.Model):
    ...
    title = models.CharField(max_length=200)
    variant_id = ShortUUIDField(unique=True, length=6, max_length=20, alphabet='0123456789')
    date = models.DateTimeField(default=timezone.now)
...
class VariantItem(models.Model):
    ...
    title = models.CharField(max_length=100)
    description = models.TextField(null=True, blank=True)
    file = models.FileField(upload_to='course-file', null=True, blank=True)  # Each field FileField have path to the file
    duration = models.DurationField(null=True, blank=True)
    content_duration = models.CharField(max_length=1000, null=True, blank=True)
    preview = models.BooleanField(default=False)
    variant_item_id = ShortUUIDField(unique=True, length=6, max_length=20, alphabet='0123456789')
    date = models.DateTimeField(default=timezone.now)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.title:
            ...
            # divmod is return tuple containing two values
...
class Question_Answer(models.Model):
    ...
    qa_id = ShortUUIDField(unique=True, length=6, max_length=20, alphabet='0123456789')
    date = models.DateTimeField(default=timezone.now)
...
class Question_Answer_Message(models.Model):
    ...
    qam_id = ShortUUIDField(unique=True, length=6, max_length=20, alphabet='0123456789')
    qa_id = ShortUUIDField(unique=True, length=6, max_length=20, alphabet='0123456789')
    date = models.DateTimeField(default=timezone.now)
...
class Cart(models.Model):
    ...
    country = models.CharField(max_length=100, null=True, blank=True)
    cart_id = ShortUUIDField(length=6, max_length=20, alphabet='0123456789')
    date = models.DateTimeField(default=timezone.now)
...
class CartOrder(models.Model):
    ...
    oid = ShortUUIDField(unique=True, length=6, max_length=20, alphabet='0123456789')
    date = models.DateTimeField(default=timezone.now)
...
class CartOrderItem(models.Model):
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE, related_name="order_item")
...
class Certificate(models.Model):
    course = models.ForeignKey(Course, on_delete=models.CASCADE)
    user = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True)
    certificate_id = ShortUUIDField(unique=True, length=6, max_length=20, alphabet='0123456789')
    date = models.DateTimeField(default=timezone.now)
...
class EnrolledCourse(models.Model):
    ...
    enrolled_id = ShortUUIDField(unique=True, length=6, max_length=20, alphabet='0123456789')
    date = models.DateTimeField(default=timezone.now)
    ...
    def curriculum(self):  # Chuong trinh giang day
...
class Note(models.Model):
    ...
    note_id = ShortUUIDField(unique=True, length=6, max_length=20, alphabet='0123456789')
    date = models.DateTimeField(default=timezone.now)
...
class Country(models.Model):
    ...
    tax_price = models.IntegerField(default=5)
    active = models.BooleanField(default=True)
